    ...
    return (
        <>
            <div className="h-full w-full fixed overflow-scroll top-0 z-50 bg-white">
                ...
                <div className="h-[350px] flex  w-full mt-8 ">

                    <div className="relative h-[200px] w-[300px] ml-4 hover:scale-105 cursor-pointer"
                        onClick={() => window.location.href = 'https://www.sciencedirect.com/science/article/abs/pii/S0378112722004364'}
                    ...
                    <div className="relative h-[200px] w-[300px] ml-14 hover:scale-105 cursor-pointer"
                        onClick={() => window.location.href = 'https://www.mdpi.com/2079-7737/11/4/491'}
                    >
                        <div
                            className="absolute inset-0 bg-cover bg-center"
                            style={{ backgroundImage: "url('traditionalwoods.jpg')" }}
                        ></div>
                        <div className="absolute inset-0 bg-black opacity-50"></div>
                        <div className="relative flex items-center justify-center h-full">
                            <div className="text-white text-center text-[30px] p-4">
                                Traditional Ecological Knowledge
                            </div>
                        </div>
                    </div>

                    <div className="relative h-[200px] w-[300px] ml-14 mr-4 hover:scale-105 cursor-pointer"
                        onClick={() => window.location.href = 'https://www.mdpi.com/2079-7737/12/4/610'}
                    >
                        <div
                            className="absolute inset-0 bg-cover bg-center"
                            style={{ backgroundImage: "url('Wildlife.jpg')" }}
                        ></div>
                        <div className="absolute inset-0 bg-black opacity-50"></div>
                        <div className="relative flex items-center justify-center h-full">
                            <div className="text-white text-center text-[40px] p-4">
