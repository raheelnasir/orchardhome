...
export default function Home() {
  ...
  return (
    <>
      <div className=''>
        <header className="relative h-[80vh] mb-20 !bg-top flex items-end justify-center text-white">
          <img src="/boat.png" alt="Background Image" className="absolute inset-0 w-full h-full object-cover z-0" />
